(function (window) {
  ...
  // API url
  window.__env.apiUrl = 'http://localhost:59704/api/beehiveapi/';
  ...
  window.__env.app = "Beehive",
    window.__env.baseUrl = 'http://localhost:59704/api/beehive/',
    window.__env.integratedBaseUrl = 'http://localhost:59704/api/',
    window.__env.autoCompleteUrl = 'http://localhost:59704/api/beehive/getSearchAutocomplete',
